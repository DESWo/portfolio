...
export const fusioncore: Project = {
  ...
  achievements: [
    'Reaction-rate fit pinned against the Bosch–Hale parameterisation to within 10% from 3–40 keV.',
...
npm run test:e2e  # browser smoke: boots and plays the real app at 3 widths`,
          ...
          {
            kind: 'text',
            text: 'The reactivity fit is the check I am most glad I wrote. It is pinned against the Bosch–Hale parameterisation at eight temperatures that are not fit anchors, and asserted to stay monotonic — so a typo in a single anchor point cannot quietly bend the curve and make the whole game easier.',
          },
        ],
      },
      {
        ...
        blocks: [
          {
            ...
            items: [
              ...
              'Three colourblind palettes, with status shape-coded — never colour alone.',
